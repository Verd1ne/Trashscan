  ...
  return (
    <div className='h-screen overflow-hidden container'>
      ...
      <div className='h-screen bg-white pb-12 font-semibold p-10 lg:p-16 lg:px-[48px] xl:px-[60px] w-4/5 mx-auto'>
        ...
        <h2 className='text-4xl lg:text-5xl xl:text-6xl text-left lg:text-center font-semibold ml-12 lg:ml-0 text-black mt-12 mb-4 md:mb-8 lg:mb-12 xl:mb-16'>Login</h2>
        ...
        <h4 className='w-full text-center text-black font-bold'>Don't have an account? <Link to="/register"> Register Now!</Link></h4>
      </div>
    </div>
  )
}